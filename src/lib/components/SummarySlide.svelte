<script>
	...
	// Data preparation (Consolidated from all versions)
	...
	const emojiFactoryBadge = $derived(
		user.metrics.badges.find((b) => b.id === 'emoji-machine' || b.label === 'Fabryka Emoji')
	);
...
<div class="group relative h-full w-full overflow-hidden bg-black font-black text-black uppercase">
	...
	{#if layoutIndex === 0}
		<!-- LAYOUT 1 (v1 style: relatively ordered) -->
		<div class="grid h-full w-full grid-cols-4 grid-rows-11 gap-0 border-4 border-black">
			<div
	...
	{:else if layoutIndex === 1}
		<!-- LAYOUT 2 (v2 style: dense & vertical variation) -->
		<div class="grid h-full w-full grid-cols-4 grid-rows-12 gap-0 border-4 border-black">
			<div
				class="relative col-span-4 row-span-1 flex items-center justify-center overflow-hidden border-2 border-black bg-white"
			>
				<h2
			...
			<div
				class="relative col-span-2 row-span-3 flex flex-col items-center justify-center border-2 border-black bg-pink-400 p-2"
			>
				<div
					class="mb-2 h-16 w-16 shrink-0 overflow-hidden border-2 border-black bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] md:h-24 md:w-24 md:border-4"
				>
			...
			<div
				class="col-span-1 row-span-1 flex flex-col items-center justify-center border-2 border-black bg-yellow-400 p-1"
			>
				<div class="text-[8px] leading-none md:text-xs">Rank</div>
				<div class="text-2xl leading-none md:text-5xl">#{user.metrics.rank}</div>
			</div>
			...
			<div
				class="col-span-1 row-span-1 flex flex-col items-center justify-center border-2 border-black bg-cyan-400 p-1"
			>
				<div class="text-center text-[8px] leading-none md:text-xs">Seria</div>
				<div class="text-xl leading-none md:text-4xl">{user.metrics.longestStreak}</div>
			</div>
			...
			<div
				class="col-span-2 row-span-2 flex flex-col items-center justify-center border-2 border-black bg-green-400 p-2"
			>
				<div class="text-center text-[8px] leading-none uppercase opacity-80 md:text-xs">
					Wiadomości
				</div>
				<div class="text-center text-2xl leading-none md:text-5xl">
					{user.metrics.totalMessages.toLocaleString()}
				</div>
			</div>

			<div
				class="relative col-span-3 row-span-2 flex flex-col justify-center border-2 border-black bg-orange-500 p-2 md:p-4"
			>
				<div class="text-[8px] opacity-80 md:text-xs">Główny Kanał</div>
				<div
					class="text-[clamp(0.5rem,4vw,1rem)] leading-[0.9] wrap-break-word md:text-xl md:break-all md:whitespace-normal"
				...
				<div class="mt-1 text-[10px] font-black md:text-sm">{mainChannelPercent}% wiadomości</div>
				<div class="mt-2">
					<div class="text-[8px] opacity-80 md:text-xs">Zasięg</div>
					<div class="mt-1 flex gap-0.5 md:gap-1">
						{#each Array(5) as _, i}
			...
			<div
				class="col-span-1 row-span-1 flex flex-col items-center justify-center border-2 border-black bg-purple-500 p-1 text-white"
			>
				<div class="text-center text-[8px] opacity-80 md:text-xs">Emoji</div>
				<div class="flex h-8 w-8 items-center justify-center md:h-12 md:w-12">
					{#if topEmojiData?.emoji_id && !failedEmoji}
			...
			<div
				class="col-span-1 row-span-1 flex flex-col items-center justify-center border-2 border-black bg-red-500 p-1 text-white"
			>
				<div class="text-center text-[8px] leading-tight opacity-80 md:text-xs">STARBOARD</div>
				<div class="text-lg leading-none md:text-4xl">{starboardCount}</div>
			</div>
			...
			<div
				class="relative col-span-2 row-span-1 flex flex-col justify-center overflow-hidden border-2 border-black bg-white p-2"
			>
				<div class="text-[8px] opacity-60 md:text-xs">Ulubione Słowo</div>
				<div class="text-[0.7rem] leading-tight wrap-break-word md:text-xl">"{topWord}"</div>
			</div>
			...
			<div
				class="relative col-span-2 row-span-1 flex flex-col justify-center overflow-hidden border-2 border-black bg-neutral-100 p-2"
			>
				<div class="text-[8px] opacity-60 md:text-xs">Unikalne Słowo</div>
				<div class="text-[0.7rem] leading-tight wrap-break-word md:text-xl">"{uniqueWord}"</div>
			</div>
			...
			<div
				class="col-span-1 row-span-1 flex flex-col items-center justify-center border-2 border-black bg-lime-400 p-1"
			>
				<div class="text-center text-[8px] opacity-80 md:text-xs">Ordery</div>
				<div class="text-xl leading-none md:text-4xl">{badgesEarned}</div>
			</div>

			<div
				class="col-span-1 row-span-1 flex flex-col items-center justify-center border-2 border-black bg-blue-300 p-1"
			>
				<div class="text-center text-[8px] opacity-80 md:text-xs">Dni Aktyw.</div>
				<div class="text-xl leading-none md:text-4xl">{activeDays}</div>
			</div>
			...
			<div
				class="relative col-span-2 row-span-1 flex flex-col justify-center border-2 border-black bg-indigo-600 p-2 text-white"
			>
				<div class="text-[8px] opacity-80 md:text-xs">Najaktywniej</div>
				<div class="text-sm leading-none wrap-break-word md:text-xl">{mostActiveDay}</div>
			</div>

			<div
				class="col-span-3 row-span-1 flex flex-col justify-center border-2 border-black bg-cyan-600 p-2 text-white"
			>
				<div class="text-[8px] opacity-80 md:text-xs">Najczęściej Oznaczasz</div>
				<div class="text-sm leading-none wrap-break-word md:text-xl">{mostPinged}</div>
			</div>
			...
			<div
				class="relative col-span-1 row-span-1 flex flex-col items-center justify-center border-2 border-black bg-yellow-300 p-1"
			>
				<div class="text-center text-[8px] leading-tight opacity-80 md:text-xs">MEDIA</div>
				<div class="text-lg leading-none md:text-3xl">{mediaCount}</div>
			</div>
			...
			<div
				class="col-span-1 row-span-1 flex flex-col items-center justify-center border-2 border-black bg-orange-300 p-1"
			>
				<div class="text-center text-[8px] leading-tight opacity-80 md:text-xs">SESJE</div>
				<div class="text-lg leading-none md:text-3xl">{sessionCount}</div>
			</div>
			...
			<div
				class="col-span-3 row-span-1 flex flex-col justify-center border-2 border-black bg-blue-700 p-2 text-white"
			>
				<div class="text-[8px] opacity-80 md:text-xs">Najczęściej Oznacza Cię</div>
				<div class="text-sm leading-none wrap-break-word md:text-xl">{topPinger}</div>
			</div>
			...
			<div
				class="col-span-2 row-span-1 flex flex-col justify-center border-2 border-black bg-blue-500 p-3 text-white"
			>
				<div class="text-[8px] opacity-80 md:text-xs">TRYB ŻYCIA</div>
				<div class="flex items-baseline gap-2">
					<span class="text-sm md:text-2xl">{sleepStart}:00</span>
					<span class="px-1 text-[10px] font-black opacity-50 md:text-sm">DO</span>
					<span class="text-sm md:text-2xl">{sleepEnd}:00</span>
				</div>
				<div class="text-[6px] italic opacity-70 md:text-[10px]">Cisza nocna</div>
			</div>
			...
			<div
				class="col-span-2 row-span-1 flex flex-col justify-center border-2 border-black bg-pink-500 p-2 text-white"
			>
				<div class="text-[8px] uppercase opacity-80 md:text-xs">Fabryka Emoji</div>
				{#if emojiFactoryBadge}
					<div class="flex items-baseline gap-1">
						<span class="text-xl leading-none md:text-3xl"
							>{(emojiFactoryBadge.progress * 100).toFixed(1)}%</span
						>
						<span class="text-[10px] leading-none opacity-80 md:text-sm">wiadomości</span>
					</div>
				{:else}
					<div class="text-xs italic opacity-70">Brak danych</div>
				{/if}
			...
			<div
				class="relative col-span-1 row-span-1 flex flex-col items-center justify-center border-2 border-black bg-amber-400 p-1"
			>
				<div class="text-[8px] opacity-80 md:text-xs">CAPS</div>
				<div class="text-lg leading-none md:text-3xl">{capsRatio}%</div>
			</div>
			...
			<div
				class="col-span-2 row-span-1 flex items-center justify-center border-2 border-black bg-black p-2 text-center text-white"
			>
				<span class="text-[8px] font-black tracking-widest md:text-sm">KARCZMA WRAPPED 2025</span>
			</div>

			<div
				class="relative col-span-1 row-span-1 flex flex-col items-center justify-center border-2 border-black bg-sky-400 p-1"
			>
				<div class="text-center text-[8px] leading-tight opacity-80 md:text-xs">ŚR. MSG</div>
				<div class="text-lg leading-none md:text-3xl">{avgMessagesPerDay}</div>
			</div>
		</div>
	{:else}
		<!-- LAYOUT 3 (v3 style: maximum chaos & integrated footer) -->
		<div class="grid h-full w-full grid-cols-4 grid-rows-11 gap-0 border-4 border-black">
			<div
				class="relative col-span-4 row-span-1 flex items-center justify-center overflow-hidden border-2 border-black bg-white"
			>
