<script>
	...
	const questionRatio = $derived(
		((user.metrics.contentHabits?.questionRatio || 0) * 100).toFixed(1)
	);
...
<div class="h-full w-full overflow-hidden bg-black font-black text-black uppercase">
	<div
		class="grid h-full w-full grid-cols-4 grid-rows-[repeat(12,minmax(0,1fr))] gap-0 border-4 border-black"
	>
		<!-- ROW 1: TITLE (STAYS ORDERED) -->
		<div
